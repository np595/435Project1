...
class Problem1Iterative{
       ...
       Node getRandomArray(int size){
                ...
                int leftCheck = heightCheck(temp.left);
                int rightCheck = heightCheck(next.right);
                System.out.println("Height of Left: " + leftCheck);
                System.out.println("Height of Left: " + rightCheck);
